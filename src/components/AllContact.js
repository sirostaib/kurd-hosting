...
useEffect(()=>{
     ...
     const unsubscribe = app.firestore().collection('Contacts').onSnapshot(snap=>{
           ...
           <Container >
            <MaterialButtonLightStack>
              ...
              <Information>
                ...
                <AddressColumnRow>
                  <AddressColumn>
                    <Address><strong>Message: </strong>{item.message}</Address>
                ...
                <OwnerFullNameColumnRow>
                  <OwnerFullNameColumn>
                    <OwnerFullName>Email: {item.email}</OwnerFullName>
